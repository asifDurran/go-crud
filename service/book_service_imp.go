...
import (
	"context"
	"crud-golang/data/request"
	"crud-golang/data/response"
	"crud-golang/helper"
	"crud-golang/model"
...
func NewBookServiceImpl(bookRepository repository.BookRespository) BookService {
